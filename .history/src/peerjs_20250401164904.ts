...
const TRANSMISSION_SIGNAL = 'transmissionSignal';
...
export class CallPeer {
    ...
    OnLlamadaEntrante_Ring() {

    }

    OnLlamadaEntrante_Answer() {
    ...
    public SetOnLlamadaEntrante_Ring(onLl: () => void) {
        this.OnLlamadaEntrante_Ring = onLl;
    }

    private SetOnLlamadaEntrante_Answer(onLl: () => void) {
        this.OnLlamadaEntrante_Answer = onLl;
    }
    ...
    public StartListeningWithID(myIdPeer: string) {
        ...
        window.addEventListener(TRANSMISSION_SIGNAL, (event:any) =>{
    ...
    // es el problema de los eventos 
    private StartCallRinging(connection: any) {
        this.currentConnection = connection;
        connection.on('data', (data: any) => {
            console.log('data', data);
            let event = new CustomEvent(TRANSMISSION_SIGNAL, { detail: data });
